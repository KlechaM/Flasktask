...
class UsersTests(unittest.TestCase):
    ...
    def test_task_template_displays_logged_in_user_name(self):
        self.create_user('Flechtcher', 'fletcher@realpython.com', 'python101')
        self.login('Flechtcher', 'python101')
        response = self.app.get('tasks/', follow_redirects=True)
        self.assertIn(b'Flechtcher', response.data)
    ...
    def test_useres_can_see_task_modify_links_for_tasks_created_by_them(self):
        self.create_user('Michael', 'michael@realpython.com', 'python')
        self.login('Michael', 'python')
        self.app.get('tasks/', follow_redirects=True)
        self.create_task()
